...
void E_Renderer::CreateSwapChain()
{
    ...
    if (vkCreateSwapchainKHR(m_logicalDevice, &createInfo, nullptr, m_swapChain.replace()) != VK_SUCCESS) {
...
void E_Renderer::CreateImageViews()
{
    ...
    for (uint32_t i = 0; i < m_swapChainImages.size(); i++) {
        ...
        if (vkCreateImageView(m_logicalDevice, &createInfo, nullptr, m_swapChainImageViews[i].replace()) != VK_SUCCESS) {
